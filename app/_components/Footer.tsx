  ...
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-md">
      <strong className="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
        Be the First to Get New Features & Whiteboard Hacks!
      </strong>
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-cyan-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-cyan-700"
          >
            Subscribe
          </button>
        </div>
    ...
    <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div className="mx-auto max-w-sm lg:max-w-none">
        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
          Subscribe to our newsletter to get the latest updates, tips on using your digital whiteboard effectively, sneak peeks at upcoming tools, and exclusive beta invites.
        </p>
