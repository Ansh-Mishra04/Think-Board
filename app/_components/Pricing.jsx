...
<div className='border-t border-gray-200 pt-5'>
  ...
  <div class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 item">
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
    <div class="divide-y divide-gray-200 rounded-2xl border border-gray-300 shadow-xs bg-gray-100">
      <div class="p-6 sm:px-8">
        ...
        <a
          class="mt-4 block rounded-sm border border-cyan-600 bg-cyan-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-cyan-600 focus:ring-3 focus:outline-hidden sm:mt-6"
          href="#"
        >
          Get Started
        </a>
        ...
        <ul class="mt-2 space-y-2 sm:mt-4">
          <li class="flex items-center gap-1">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="size-5 text-cyan-700 shadow-sm"
            >
